...
import { profileLogoutSuccessMsg, profileLogoutFailureMsg } from "@constants"
...
const ProfileScreen: React.FC<Props> = () => {
	...
	const doLogout = async () => {
		...
		try {
			await logout()
			showSnack(profileLogoutSuccessMsg, SnackType.Success)
		} catch (err: any) {
			console.log('Error while logging out:', err)
			showSnack(`${profileLogoutFailureMsg}${err}`, SnackType.Error)
		} finally {
			setLoading(false)
		}
	}
